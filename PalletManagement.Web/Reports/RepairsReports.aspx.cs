    ...
    public partial class RepairsReports : System.Web.UI.Page
    {
        ...
        private void GetReports()
        {
            try
            {
                ...
                var report = _damageServices.GetPalletSummary(startDate, endDate, customerId, facilityId);
                var formatedReport = _damageServices.GetDisplayList(report);
        ...
        private void LoadDamagesByFacility(int facilityId)
        {
            try
            {
                ...
                var damages = _damageServices.GetList().Where(x => x.facilityId == facilityId);
                ...
                gdvRepairsBreakdown.DataSource = _damageServices.GetDisplayList(damages.ToList());
                gdvRepairsBreakdown.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void lnkOverallSummaryExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Charset = "";
            string FileName = "Damages_Summary_Report_" + DateTime.Now.ToString("dd_MM_yyyy") + ".xls";
        ...
        protected void lnkbreakdown_Click(object sender, EventArgs e)
        {
            ...
            Response.ClearHeaders();
            Response.Charset = "";
            string FileName = "Damages_Breakdown_Report_" + DateTime.Now.ToString("dd_MM_yyyy") + ".xls";
            StringWriter strwritter = new StringWriter();
            HtmlTextWriter htmltextwrtter = new HtmlTextWriter(strwritter);
            Response.Cache.SetCacheability(HttpCacheability.NoCache);
            Response.ContentType = "application/vnd.ms-excel";
